...
CREATE TABLE `playlist` (
  ...
  `playlist_comment` varchar(1024) DEFAULT NULL COMMENT '备注',
  `playlist_type` int(10) DEFAULT NULL COMMENT '歌单类型（0普通歌单，1排行榜，2我的歌单）',
  `icon` varchar(255) DEFAULT NULL COMMENT '歌单图片',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7095271312 DEFAULT CHARSET=utf8;
...
CREATE TABLE `playlist_song` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40837 DEFAULT CHARSET=utf8;
...
CREATE TABLE `singer` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=50950196 DEFAULT CHARSET=utf8;
...
CREATE TABLE `song` (
  ...
  `song_url` varchar(1024) DEFAULT NULL COMMENT '歌曲文件地址',
  `picture_url` varchar(255) DEFAULT NULL COMMENT '歌曲封面地址',
  `comment` varchar(300) DEFAULT NULL COMMENT '备注(0爬取，1自己手动修改)',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1906568527 DEFAULT CHARSET=utf8;
