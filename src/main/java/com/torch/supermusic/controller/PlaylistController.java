...
public class PlaylistController {
    ...
    public ResultVo PageSong(SelectAndPage selectAndPage){
        return ResultUtils.success("查询成功", playlistService.page(new Page<Playlist>(selectAndPage.getCurrentPage(), selectAndPage.getPageSize()),new QueryWrapper<Playlist>().like("playlist_name",selectAndPage.getArg())));
    }
